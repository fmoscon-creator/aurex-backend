...
async function buildDailyStatus(format) {
  ...
  if (format === 'telegram') {
    ...
    t += '   Build ' + stores.apple.build + ' (Marketing Version 1.0)\n';
    t += '   ' + stores.apple.timeSince + '\n';
    t += '   Submit: 24-abr-2026 5:24 AM AR\n';
    t += '   ID envío: e0e7fb35-11a4-4c1d-854c-60a80c4799e6\n';
    t += '   Apple Account: fmoscon@gmail.com | Team ID: TX7C2F79U9\n';
    t += '   Apple App ID: 6761672161 | Bundle: com.fernandomoscon.aurex\n';
    ...
    t += '   Build ' + stores.google.build + ' (versionName 1.0.1, versionCode 2)\n';
    t += '   ' + stores.google.timeSince + ' (de 14 días de prueba cerrada)\n';
    t += '   Submit: 23-abr-2026 16:20 AR\n';
    t += '   Bundle: com.aurexapp | Categoría: Herramientas\n';
    t += '   12+ testers activos\n\n';
    t += '📦 REPOS\n';
